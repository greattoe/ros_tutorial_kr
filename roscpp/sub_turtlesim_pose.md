...
add_executable(turtlesim_teleop src/turtlesim_teleop.cpp) # 여기에 추가
...
#                       --------------------
#              노드명 -------------^
target_link_libraries(turtlesim_teleop  ${catkin_LIBRARIES} ) # 여기에 추가
...
{
  ros::init(argc, argv, "turtlesim_teleop");
  ros::NodeHandle nh;
